class Solution {
  ...
  public long subArrayRanges(int[] nums) { //O(10N) O(10N)
        return sumSubarrayMaxs(nums) - sumSubarrayMins(nums);//sum of subarray minimum and sum of subarray maximums difference is answer
    }
